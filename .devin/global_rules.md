...
- `worker.js`: Cloudflare Edge proxy verifying Supabase RS256 JWTs via the project's JWKS endpoint, with a legacy `X-Beta-Key` fallback, handling CORS, and forwarding batch pipeline requests to Turso.
